...
import tisHermitBooster.tisHermitBoosterMod;
import tisHermitBooster.util.CardStats;
import tisHermitBooster.util.TriFunction;
...
import static tisHermitBooster.util.GeneralUtils.removePrefix;
import static tisHermitBooster.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return tisHermitBoosterMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    tisHermitBoosterMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
